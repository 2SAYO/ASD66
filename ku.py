...
\x1b[1;97m———————————————————————————————\033[1;41m\033[1;97m𝐒 𝐀 𝐘 𝐎\033[;0m\033[1;91m\x1b[1;97m————————————————————————————————
             ...
             \033[1;31m╠══\033[1;33m{w}𝗚{r}𝗜{w}𝗧{r}𝗛{w}𝗨{r}𝗕              \x1b[1;97m•          \u001b[38;5;35m{w}2{r}𝗦{w}𝗔{r}𝗬{w}𝗢   \033[1;31m║
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f"""\r\r\x1b[38;5;47m
╔═════════════ஜ𝐎𝐊ஜ═════════════╗
 彡𝐄 𝐌 𝐀 𝐈 𝐋 ➽ {ids}

 彡𝐏  𝐀  𝐒  𝐒 ➽ {pas}
 
 彡𝐃𝐀𝐓𝐄 𝐂𝐑𝐄𝐀𝐓𝐄𝐃 ➽ {creatdate(ids)}
